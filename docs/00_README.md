...
| `workdiary.md` | Running log of development. Newest entry shows what was last done, current tool inventory, open items. Read the latest entry at the start of any non-trivial session; update at the end. |
